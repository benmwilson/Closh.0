...
void terminator(int inSignal)
{ // handler function for the alarm, aka the terminator
    ...
    { // main shell input loop
        ...
        { // sequential execution
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (childPid == -1)
                { // quick error catching, display error msg
                ...
                { // have child process do its work and then immediately exit
                ...
                { // wait for child process to wrap up
